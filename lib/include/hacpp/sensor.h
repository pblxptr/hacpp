...
public:
  ...
  struct Defs {
    constexpr static auto Component = "sensor";
...
private:
  ...
  EntityCfg cfg_{
      {Sensor::Opt::StateTopic,
       default_component_state_topic(Sensor::Defs::Component, unique_id_)}};
